...
fn u8_hex_decode_test(){
    ...
    assert_eq!(u8_bin, generic_hex_to_base64::hex_decode::<u8>(hex));
}
...
fn u16_hex_decode_test(){
    ...
    assert_eq!(u16_bin, generic_hex_to_base64::hex_decode::<u16>(hex));
}
...
fn u32_hex_decode_test(){
    ...
    assert_eq!(u32_bin, generic_hex_to_base64::hex_decode::<u32>(hex));
}
...
fn u64_hex_decode_test(){
    ...
    assert_eq!(u64_bin, generic_hex_to_base64::hex_decode::<u64>(hex));
}
...
fn u8_base_64_encode_test() {
    ...
    assert_eq!(base_64_encoded,generic_hex_to_base64::encode_to_base64(generic_hex_to_base64::hex_decode::<u8>(based_64_hex)));
}
...
fn u16_base_64_encode_test() {
    let based_64_hex = "49276d206b696c6c696e6720796f757220627261696e206c696b65206120706f69736f6e6f7573206d757368726f6f6d";
    let base_64_encoded = "SSdtIGtpbGxpbmcgeW91ciBicmFpbiBsaWtlIGEgcG9pc29ub3VzIG11c2hyb29t";
    assert_eq!(base_64_encoded,generic_hex_to_base64::encode_to_base64(generic_hex_to_base64::hex_decode::<u16>(based_64_hex)));
}
...
fn u32_base_64_encode_test() {
    let based_64_hex = "49276d206b696c6c696e6720796f757220627261696e206c696b65206120706f69736f6e6f7573206d757368726f6f6d";
    let base_64_encoded = "SSdtIGtpbGxpbmcgeW91ciBicmFpbiBsaWtlIGEgcG9pc29ub3VzIG11c2hyb29t";
    assert_eq!(base_64_encoded,generic_hex_to_base64::encode_to_base64(generic_hex_to_base64::hex_decode::<u32>(based_64_hex)));
}
...
fn u64_base_64_encode_test() {
    let based_64_hex = "49276d206b696c6c696e6720796f757220627261696e206c696b65206120706f69736f6e6f7573206d757368726f6f6d";
    let base_64_encoded = "SSdtIGtpbGxpbmcgeW91ciBicmFpbiBsaWtlIGEgcG9pc29ub3VzIG11c2hyb29t";
    assert_eq!(base_64_encoded,generic_hex_to_base64::encode_to_base64(generic_hex_to_base64::hex_decode::<u64>(based_64_hex)));
}
