...
fn challenge_5_repeating_key_xor(){
    ...
    assert_eq!(repeating_xor::repeating_xor(plain_text.into_bytes(), key.into_bytes()), hex_to_base64::hex_decode(correct_cipher_text));
}
